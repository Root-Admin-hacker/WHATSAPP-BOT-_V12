...
// Function to add reaction to any text message
async function addMessageReaction(sock, message) {
    try {
        ...
        if (text.startsWith('.autoreact')) return;
        
        // Add random delay to make reactions feel more natural (200-800ms)
        ...
        // Silently fail for reactions (don't spam console)
...
module.exports = {
    addMessageReaction,      // Fixed: was addCommandReaction before
